...
<body class="bg-slate-50 text-slate-800 flex flex-col min-h-screen">
    ...
    <!-- Hero Section -->
    <section class="bg-gradient-to-r from-emerald-700 to-teal-800 text-white py-10 md:py-14">
    ...
    <section id="cara-order" class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mb-8">
        <h3 class="text-xl font-bold text-center text-slate-800 mb-8 flex items-center justify-center">
            <i class="fa-solid fa-list-check text-emerald-600 mr-2"></i> 3 Langkah Transaksi Mudah
        </h3>
    ...
    <section id="keunggulan" class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 mb-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition">
                ...
                <p class="text-xs text-slate-600 leading-relaxed">Sistem terintegrasi memastikan pulsa, kuota, token PLN, atau top up game masuk secara kilat setelah pembayaran dikonfirmasi.</p>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition">
