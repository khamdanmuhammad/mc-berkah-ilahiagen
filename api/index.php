...
<body class="bg-slate-50 text-slate-800 flex flex-col min-h-screen">
    ...
    <header class="sticky top-0 z-50 bg-emerald-700 text-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <a href="https://wa.me/6281234567890" target="_blank" class="bg-amber-400 hover:bg-amber-500 text-slate-900 font-semibold px-4 py-2 rounded-lg text-sm transition shadow">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-emerald-800 px-4 pt-2 pb-4 space-y-2 text-sm">
            <a href="#layanan" class="block py-2 hover:text-emerald-200">Layanan</a>
            <a href="#harga" class="block py-2 hover:text-emerald-200">Cek Harga</a>
            <a href="#cara-order" class="block py-2 hover:text-emerald-200">Cara Transaksi</a>
            <a href="#kontak" class="block py-2 hover:text-emerald-200">Bantuan</a>
            <a href="https://wa.me/6281234567890" target="_blank" class="inline-block w-full text-center bg-amber-400 text-slate-900 font-semibold py-2 rounded-lg mt-2">
                <i class="fa-brands fa-whatsapp mr-1"></i> Hubungi CS
            </a>
        </div>
    </header>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left grid md:grid-cols-2 gap-8 items-center">
            <div>
                ...
                <div class="mt-6 flex flex-wrap gap-3 justify-center md:justify-start">
                    <a href="#layanan" class="bg-amber-400 hover:bg-amber-500 text-slate-900 font-bold px-6 py-3 rounded-lg shadow-lg transition text-sm">Transaksional Sekarang</a>
                </div>
            </div>
    ...
    <script>
        ...
        function handleOrder(e) {
            ...
            const adminWA = "6281234567890"; // Ganti dengan nomor WhatsApp Anda
